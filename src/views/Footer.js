  ...
  render = () => {
    return (
      <footer className="pt-4 site-footer bg-primary text-center">
        ...
        <p>
          We use r-spacex API <a target="_blank" rel="noopener noreferrer" href="https://github.com/r-spacex/SpaceX-API">(github)</a> to track data about SpaceX
          </p>
        <div className=" bottom-footer mt-3 py-3">
          <p className="mb-2" >Frontend project developed by Julián Sanmartino</p>
